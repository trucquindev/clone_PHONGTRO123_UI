  ...
  return (
    <div className="w-full flex border-t border-orange-700 p-1">
      ...
      >
              ...
              if (i !== null) {
                return (
                  <img
                    ...
                    alt="privew"
                    key={index}
                    className="w-[48%] h-[115px] object-cover"
                  />
                );
              }
            })}
        ...
        >
          {isHoverHeart ? (
            <BsFillSuitHeartFill size={22} color="pink" />
          ) : (
            <BsSuitHeart size={22} />
          )}
        </span>
      ...
      <div className="w-3/5">
        ...
        <div className="my-2 flex items-center justify-between">
          ...
          <span className="text-[14px] flex-3 whitespace-nowrap text-ellipsis overflow-hidden">{`${
